        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <form action="{{route('updateLocations')}}" method="post">
                        @csrf
                            <div class="col-sm-12">
                                <input type="text" id="pac-input" style="height: 40px;width: 250px;padding: 15px">
                                <input type="hidden" name="latitude" id="latitude" value="{{loggedAdmin('latitude')}}">
                                <input type="hidden" name="longitude" id="longitude" value="{{loggedAdmin('longitude')}}">
                                <div class="map" id="map" style="max-height: 200px!important;">
    ...
    <script>
        ...
        function initAutocomplete() {
            var map = new google.maps.Map(document.getElementById('map'), {
                center: {
                    lat: {{loggedAdmin('latitude') ?? 39.1003215}},
                    lng: {{loggedAdmin('longitude') ?? 30.6003215}}
                },
                zoom: 13,
                mapTypeId: 'roadmap'
            });
