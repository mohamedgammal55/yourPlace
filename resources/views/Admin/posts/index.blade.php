...
@section('title')  {{($setting->title) ?? ''}} | News @endsection
@section('page_name') News @endsection
@section('content')
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Posts And News</h3>
                    <p class="text-gray mt-2">Add News And Posts To Be Shown To The Users</p>
                    <div class="">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered w-100" id="dataTable">
                            ...
                            <tr class="fw-bolder text-muted bg-light">
                                ...
                                <th class="max-w-50px">Details</th>
        ...
        <div class="modal fade" id="editOrCreate" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Post Data</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
