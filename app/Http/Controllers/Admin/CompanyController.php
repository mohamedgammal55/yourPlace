...
class CompanyController extends Controller
{
    ...
    {
        if($request->ajax()) {
            $admins = Admin::where('role','company')->latest()->get();
    ...
    public function myProfile()
    {
        ...
        return view('Admin/company/profile',compact('admin'));
    }//end fun



    public function create(){
        return view('Admin/company.parts.create');
    }
    ...
    public function edit($id){
        ...
        return view('Admin/company.parts.edit',compact('admin'));
    }
    ...
    {
        $company = Admin::find(loggedAdmin('id'));
        $company->update($request->only('latitude','longitude'));
